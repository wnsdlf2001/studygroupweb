...
/* 지역 데이터 */
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '서울', '강남');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '서울', '홍대/신촌');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '서울', '종로');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '서울', '신사');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '서울', '목동');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '서울', '잠실');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '서울', '양재');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '서울', '사당');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '서울', '노원');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '서울', '은평');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '서울', '혜화');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '서울', '성수');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '서울', '인사동');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '경기', '고양');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '부산', '서면');
INSERT INTO WS_LOCATION VALUES(SEQ_WS_LOCATION_id.NEXTVAL, '인천', '송도');
...
/* 유저 데이터 */
Insert into ENCORE.WS_USER (ID,EMAIL,NAME,NICK,PIC,BIRTH,GENDER,PHONE,PASSWD,PRIME,RATE,POINT,REGDATE,ADDRESS,ZIPCODE) values (1,'fff@fff.fff','김이름','ireum12345','pic',to_date('89/07/24','RR/MM/DD'),'남','010-1234-5667','12345','0',0,0,to_date('19/07/24','RR/MM/DD'),'경기 성남시 분당구 판교역로 235 (삼평동)@101호','13494');
Insert into ENCORE.WS_USER (ID,EMAIL,NAME,NICK,PIC,BIRTH,GENDER,PHONE,PASSWD,PRIME,RATE,POINT,REGDATE,ADDRESS,ZIPCODE) values (2,'alice91897@gmail.com','신유진','신뉴','pic',to_date('96/09/18','RR/MM/DD'),'여','01095793739','Dtmth9918!!','1',0,0,to_date('19/07/24','RR/MM/DD'),'서울 강남구 삼성로 150 (대치동)@107동 303호','06288');
Insert into ENCORE.WS_USER (ID,EMAIL,NAME,NICK,PIC,BIRTH,GENDER,PHONE,PASSWD,PRIME,RATE,POINT,REGDATE,ADDRESS,ZIPCODE) values (3,'jaeyoung@gmail.com','대조영','조02','pic',to_date('09/12/16','RR/MM/DD'),'남','0111234567','!234o','1',0,0,to_date('19/07/24','RR/MM/DD'),'경기 고양시 일산서구 일현로 123 (탄현동)@발해아파트 2동 9호','10241');
Insert into ENCORE.WS_USER (ID,EMAIL,NAME,NICK,PIC,BIRTH,GENDER,PHONE,PASSWD,PRIME,RATE,POINT,REGDATE,ADDRESS,ZIPCODE) values (4,'joonil@naver.com','윤준일','chocoz','pic',to_date('19/06/30','RR/MM/DD'),'남','01095959595','1234','0',0,0,to_date('19/07/24','RR/MM/DD'),'서울 강동구 풍산로 237 (강일동)@어딘가','05208');
Insert into ENCORE.WS_USER (ID,EMAIL,NAME,NICK,PIC,BIRTH,GENDER,PHONE,PASSWD,PRIME,RATE,POINT,REGDATE,ADDRESS,ZIPCODE) values (5,'abcde@abc.de','천둥','thunder','pic',to_date('10/01/01','RR/MM/DD'),'여','010-1234-7890','12345','1',0,0,to_date('19/07/24','RR/MM/DD'),'제주특별자치도 제주시 첨단로 242 (영평동)@산 242','63309');
Insert into ENCORE.WS_USER (ID,EMAIL,NAME,NICK,PIC,BIRTH,GENDER,PHONE,PASSWD,PRIME,RATE,POINT,REGDATE,ADDRESS,ZIPCODE) values (6,'abc@email.com','마이클','michael','pic',to_date('19/07/09','RR/MM/DD'),'여','010-0101-1111','111','0',0,0,to_date('19/07/24','RR/MM/DD'),'경기 성남시 분당구 판교역로28번길 3-5 (백현동)@백화점','13536');
Insert into ENCORE.WS_USER (ID,EMAIL,NAME,NICK,PIC,BIRTH,GENDER,PHONE,PASSWD,PRIME,RATE,POINT,REGDATE,ADDRESS,ZIPCODE) values (7,'abcd@naver.com','강나다','다나강','pic',to_date('19/07/27','RR/MM/DD'),'여','01056789012','!234o6','1',0,0,to_date('19/07/24','RR/MM/DD'),'서울 강남구 개포로32길 13 (개포동, 삼성파크빌)@3동 701호','06309');
Insert into ENCORE.WS_USER (ID,EMAIL,NAME,NICK,PIC,BIRTH,GENDER,PHONE,PASSWD,PRIME,RATE,POINT,REGDATE,ADDRESS,ZIPCODE) values (8,'abcde@hanmail.net','홍길동','redroad','pic',to_date('89/12/14','RR/MM/DD'),'여','01034567890','!234o67','0',0,0,to_date('19/07/24','RR/MM/DD'),'서울 강남구 개포로124길 27 (일원동, 삼성사원아파트)@6동 8호','06339');
Insert into ENCORE.WS_USER (ID,EMAIL,NAME,NICK,PIC,BIRTH,GENDER,PHONE,PASSWD,PRIME,RATE,POINT,REGDATE,ADDRESS,ZIPCODE) values (12,'yoojinshin9918@gmail.com','신유진','신뉴99','pic',to_date('96/09/18','RR/MM/DD'),'성별','01041639857','111!!','0',0,0,to_date('19/07/24','RR/MM/DD'),'서울 강남구 삼성로 150 (대치동)@미도아파트 207동 1407호','06288');
